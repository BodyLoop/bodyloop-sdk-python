...
T = TypeVar("T", bound="ProbandDetail")


@_attrs_define
class ProbandDetail:
    """Extended version of `Proband` that includes matching reffering Viatars
    ...
    viatars: list[Viatar] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        viatars: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.viatars, Unset):
            viatars = []
            for viatars_item_data in self.viatars:
                viatars_item = viatars_item_data.to_dict()
                viatars.append(viatars_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _viatars = d.pop("viatars", UNSET)
        viatars: list[Viatar] | Unset = UNSET
        if _viatars is not UNSET:
            viatars = []
            for viatars_item_data in _viatars:
                viatars_item = Viatar.from_dict(viatars_item_data)
        ...
        proband_detail.additional_properties = d
        return proband_detail
