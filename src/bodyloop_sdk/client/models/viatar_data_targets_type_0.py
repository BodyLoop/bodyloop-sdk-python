...
T = TypeVar("T", bound="ViatarDataTargetsType0")


@_attrs_define
class ViatarDataTargetsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        viatar_data_targets_type_0 = cls()
        ...
        viatar_data_targets_type_0.additional_properties = additional_properties
        return viatar_data_targets_type_0
