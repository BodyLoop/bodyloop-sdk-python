...
T = TypeVar("T", bound="ParametersDataOutput")


@_attrs_define
class ParametersDataOutput:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameters_data_output.additional_properties = d
        return parameters_data_output
