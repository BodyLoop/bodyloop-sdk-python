...
T = TypeVar("T", bound="ViatarHeightsType0")


@_attrs_define
class ViatarHeightsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        viatar_heights_type_0.additional_properties = additional_properties
        return viatar_heights_type_0
