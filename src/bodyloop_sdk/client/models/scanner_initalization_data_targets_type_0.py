...
T = TypeVar("T", bound="ScannerInitalizationDataTargetsType0")


@_attrs_define
class ScannerInitalizationDataTargetsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        scanner_initalization_data_targets_type_0 = cls()
        ...
        scanner_initalization_data_targets_type_0.additional_properties = additional_properties
        return scanner_initalization_data_targets_type_0
