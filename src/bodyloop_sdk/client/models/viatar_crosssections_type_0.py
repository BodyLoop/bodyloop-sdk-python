...
T = TypeVar("T", bound="ViatarCrosssectionsType0")


@_attrs_define
class ViatarCrosssectionsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        viatar_crosssections_type_0 = cls()
        ...
        viatar_crosssections_type_0.additional_properties = additional_properties
        return viatar_crosssections_type_0
