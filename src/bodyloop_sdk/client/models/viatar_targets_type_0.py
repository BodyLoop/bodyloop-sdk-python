...
T = TypeVar("T", bound="ViatarTargetsType0")


@_attrs_define
class ViatarTargetsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        viatar_targets_type_0.additional_properties = additional_properties
        return viatar_targets_type_0
