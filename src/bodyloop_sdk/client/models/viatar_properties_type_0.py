...
T = TypeVar("T", bound="ViatarPropertiesType0")


@_attrs_define
class ViatarPropertiesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        viatar_properties_type_0.additional_properties = additional_properties
        return viatar_properties_type_0
